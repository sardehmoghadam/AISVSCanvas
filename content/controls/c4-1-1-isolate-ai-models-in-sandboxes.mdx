...
standardVersion: "1.0"
controlId: C4.1.1
canonicalId: v1.0-C4.1.1
slug: c4-1-1-isolate-ai-models-in-sandboxes
title: "Isolate AI models in sandboxes"
summary: "AI models execute in isolated sandboxes."
chapter:
  id: C4
...
AI models execute in isolated sandboxes. This is a Level 1 requirement of OWASP AISVS 1.0 (Infrastructure, Configuration & Deployment Security).
...
> Verify that AI models execute in isolated sandboxes.
