...
standardVersion: "1.0"
controlId: C5.2.4
canonicalId: v1.0-C5.2.4
slug: c5-2-4-filter-unauthorized-data-from-responses
title: "Filter unauthorized data from responses"
summary: "Post-inference filtering mechanisms prevent responses from including data that the requester is not authorized to receive."
chapter:
  id: C5
...
Post-inference filtering mechanisms prevent responses from including data that the requester is not authorized to receive. This is a Level 2 requirement of OWASP AISVS 1.0 (Access Control & Identity for AI Components & Users).
...
> Verify that post-inference filtering mechanisms prevent responses from including data that the requester is not authorized to receive.
