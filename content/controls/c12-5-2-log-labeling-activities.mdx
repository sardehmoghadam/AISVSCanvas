...
standardVersion: "1.0"
controlId: C12.5.2
canonicalId: v1.0-C12.5.2
slug: c12-5-2-log-labeling-activities
title: "Log labeling activities"
summary: "All labeling activities are recorded in logs."
chapter:
  id: C12
...
All labeling activities are recorded in logs. This is a Level 1 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that all labeling activities are recorded in logs.
