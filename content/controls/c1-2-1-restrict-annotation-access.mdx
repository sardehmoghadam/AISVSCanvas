...
standardVersion: "1.0"
controlId: C1.2.1
canonicalId: v1.0-C1.2.1
slug: c1-2-1-restrict-annotation-access
title: "Restrict annotation access"
summary: "Labeling platforms enforce access controls that restrict who can create, modify, or approve annotations."
chapter:
  id: C1
...
Labeling platforms enforce access controls that restrict who can create, modify, or approve annotations. This is a Level 1 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that labeling platforms enforce access controls that restrict who can create, modify, or approve annotations.
