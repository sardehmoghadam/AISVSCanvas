...
standardVersion: "1.0"
controlId: C10.1.3
canonicalId: v1.0-C10.1.3
slug: c10-1-3-sandbox-local-mcp-servers
title: "Sandbox local MCP servers"
summary: "Locally launched MCP servers run in a least-privilege sandbox with restricted file system, network, and system access."
chapter:
  id: C10
...
relatedControls:
  ...
  - id: C10.1.2
    title: "Allow-list MCP servers"
    href: /controls/c10-1-2-allow-list-mcp-servers/
---

## What This Control Means

Locally launched MCP servers run in a least-privilege sandbox with restricted file system, network, and system access. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that locally launched MCP servers run in a least-privilege sandbox with restricted file system, network, and system access.
