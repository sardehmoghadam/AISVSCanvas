...
standardVersion: "1.0"
controlId: C2.2.4
canonicalId: v1.0-C2.2.4
slug: c2-2-4-detect-coordinated-multi-input-attacks
title: "Detect coordinated multi-input attacks"
summary: "Coordinated attacks spanning multiple input types (e.g., steganographic payloads in images combined with prompt injection in text) are detected and blocked."
chapter:
  id: C2
...
Coordinated attacks spanning multiple input types (e.g., steganographic payloads in images combined with prompt injection in text) are detected and blocked. This is a Level 3 requirement of OWASP AISVS 1.0 (Input Validation).
