...
standardVersion: "1.0"
controlId: C9.3.3
canonicalId: v1.0-C9.3.3
slug: c9-3-3-declare-tool-privileges-in-manifests
title: "Declare tool privileges in manifests"
summary: "Tool manifests declare required privileges, resource limits, and output validation requirements."
chapter:
  id: C9
...
Tool manifests declare required privileges, resource limits, and output validation requirements. This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
