...
standardVersion: "1.0"
controlId: C1.2.2
canonicalId: v1.0-C1.2.2
slug: c1-2-2-protect-labeling-artifacts-with-cryptographic-integrity
title: "Protect labeling artifacts with cryptographic integrity"
summary: "Cryptographic integrity is applied to labeling artifacts."
chapter:
  id: C1
...
Cryptographic integrity is applied to labeling artifacts. This is a Level 2 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that cryptographic integrity is applied to labeling artifacts.
