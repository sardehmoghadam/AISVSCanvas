...
standardVersion: "1.0"
controlId: C6.1.4
canonicalId: v1.0-C6.1.4
slug: c6-1-4-run-behavioral-acceptance-tests
title: "Run behavioral acceptance tests"
summary: "Models pass a behavioral acceptance test suite before being promoted to any non-development environment."
chapter:
  id: C6
...
relatedControls:
  - id: C6.2.1
    title: "Publish machine-readable AI BOMs"
    href: /controls/c6-2-1-publish-machine-readable-ai-boms/
  - id: C6.1.3
...
Models pass a behavioral acceptance test suite before being promoted to any non-development environment. This is a Level 2 requirement of OWASP AISVS 1.0 (Supply Chain Security for Models).
