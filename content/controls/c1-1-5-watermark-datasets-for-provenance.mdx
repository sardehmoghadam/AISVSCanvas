...
standardVersion: "1.0"
controlId: C1.1.5
canonicalId: v1.0-C1.1.5
slug: c1-1-5-watermark-datasets-for-provenance
title: "Watermark datasets for provenance"
summary: "Datasets are watermarked so their use can be attributed and any unauthorized use detected."
chapter:
  id: C1
...
relatedControls:
  - id: C1.2.1
    ...
    href: /controls/c1-2-1-restrict-annotation-access/
  - id: C1.1.4
...
Datasets are watermarked so their use can be attributed and any unauthorized use detected. This is a Level 3 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that datasets are watermarked so their use can be attributed and any unauthorized use detected.
