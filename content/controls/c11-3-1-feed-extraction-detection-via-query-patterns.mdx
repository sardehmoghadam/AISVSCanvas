...
standardVersion: "1.0"
controlId: C11.3.1
canonicalId: v1.0-C11.3.1
slug: c11-3-1-feed-extraction-detection-via-query-patterns
title: "Feed extraction detection via query patterns"
summary: "Query-pattern analysis feeds an extraction-attempt detector."
chapter:
  id: C11
...
Query-pattern analysis feeds an extraction-attempt detector. This is a Level 1 requirement of OWASP AISVS 1.0 (Adversarial Robustness).
...
> Verify that query-pattern analysis feeds an extraction-attempt detector.
