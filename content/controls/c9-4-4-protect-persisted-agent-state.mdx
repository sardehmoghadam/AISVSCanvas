...
standardVersion: "1.0"
controlId: C9.4.4
canonicalId: v1.0-C9.4.4
slug: c9-4-4-protect-persisted-agent-state
title: "Protect persisted agent state"
summary: "Agent state persisted between invocations is integrity-protected."
chapter:
  id: C9
...
Agent state persisted between invocations is integrity-protected. This is a Level 3 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
