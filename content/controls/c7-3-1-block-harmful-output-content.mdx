...
standardVersion: "1.0"
controlId: C7.3.1
canonicalId: v1.0-C7.3.1
slug: c7-3-1-block-harmful-output-content
title: "Block harmful output content"
summary: "Automated classifiers scan every response and block content that matches defined harmful content categories."
chapter:
  id: C7
...
relatedControls:
  ...
  - id: C7.2.3
    ...
    href: /controls/c7-2-3-verify-high-risk-responses/
---

## What This Control Means

Automated classifiers scan every response and block content that matches defined harmful content categories. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Behavior, Output Control & Safety Assurance).
...
> Verify that automated classifiers scan every response and block content that matches defined harmful content categories.
