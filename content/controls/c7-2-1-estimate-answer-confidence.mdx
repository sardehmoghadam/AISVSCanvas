...
standardVersion: "1.0"
controlId: C7.2.1
canonicalId: v1.0-C7.2.1
slug: c7-2-1-estimate-answer-confidence
title: "Estimate answer confidence"
summary: "The system assesses the reliability of generated answers using a confidence estimation method."
chapter:
  id: C7
...
relatedControls:
  ...
  - id: C7.1.2
    ...
    href: /controls/c7-1-2-bound-output-length/
---

## What This Control Means

The system assesses the reliability of generated answers using a confidence estimation method. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Behavior, Output Control & Safety Assurance).
...
> Verify that the system assesses the reliability of generated answers using a confidence estimation method.
