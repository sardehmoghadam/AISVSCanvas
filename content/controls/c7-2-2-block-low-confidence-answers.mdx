...
standardVersion: "1.0"
controlId: C7.2.2
canonicalId: v1.0-C7.2.2
slug: c7-2-2-block-low-confidence-answers
title: "Block low-confidence answers"
summary: "The application automatically blocks answers or switches to a fallback message if the confidence score drops below a defined threshold."
chapter:
  id: C7
...
The application automatically blocks answers or switches to a fallback message if the confidence score drops below a defined threshold. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Behavior, Output Control & Safety Assurance).
