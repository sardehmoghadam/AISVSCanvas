...
standardVersion: "1.0"
controlId: C5.2.5
canonicalId: v1.0-C5.2.5
slug: c5-2-5-isolate-the-policy-decision-point
title: "Isolate the policy decision point"
summary: "The policy decision point for agent authorization is isolated from the agent's execution environment."
chapter:
  id: C5
...
The policy decision point for agent authorization is isolated from the agent's execution environment. This is a Level 2 requirement of OWASP AISVS 1.0 (Access Control & Identity for AI Components & Users).
...
> Verify that the policy decision point for agent authorization is isolated from the agent's execution environment.
