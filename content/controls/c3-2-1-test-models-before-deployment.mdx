...
standardVersion: "1.0"
controlId: C3.2.1
canonicalId: v1.0-C3.2.1
slug: c3-2-1-test-models-before-deployment
title: "Test models before deployment"
summary: "Models undergo automated input validation testing, safety evaluation testing, and output sanitization testing before deployment."
chapter:
  id: C3
...
Models undergo automated input validation testing, safety evaluation testing, and output sanitization testing before deployment. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Lifecycle Management & Change Control).
...
> Verify that models undergo automated input validation testing, safety evaluation testing, and output sanitization testing before deployment.
