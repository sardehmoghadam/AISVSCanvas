...
standardVersion: "1.0"
controlId: C9.2.1
canonicalId: v1.0-C9.2.1
slug: c9-2-1-require-human-approval-for-high-impact-actions
title: "Require human approval for high-impact actions"
summary: "The agent runtime blocks execution of privileged, high-impact, or irreversible actions until explicit human approval is received and verified."
chapter:
  id: C9
...
relatedControls:
  - id: C9.2.2
    ...
    href: /controls/c9-2-2-display-canonicalized-approval-parameters/
  - id: C9.1.3
    title: "Provide a swarm kill-switch"
    href: /controls/c9-1-3-provide-a-swarm-kill-switch/
---

## What This Control Means

The agent runtime blocks execution of privileged, high-impact, or irreversible actions until explicit human approval is received and verified. This is a Level 1 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
...
> Verify that the agent runtime blocks execution of privileged, high-impact, or irreversible actions until explicit human approval is received and verified.
