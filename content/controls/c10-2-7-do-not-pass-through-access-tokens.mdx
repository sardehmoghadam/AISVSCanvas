...
standardVersion: "1.0"
controlId: C10.2.7
canonicalId: v1.0-C10.2.7
slug: c10-2-7-do-not-pass-through-access-tokens
title: "Do not pass through access tokens"
summary: "MCP servers do not pass through access tokens received from clients to downstream APIs."
chapter:
  id: C10
...
MCP servers do not pass through access tokens received from clients to downstream APIs. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
