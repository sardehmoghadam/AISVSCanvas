...
standardVersion: "1.0"
controlId: C2.1.2
canonicalId: v1.0-C2.1.2
slug: c2-1-2-detect-encoding-and-representation-smuggling
title: "Detect encoding and representation smuggling"
summary: "Encoding and representation smuggling in inputs is detected and mitigated. Approved mitigations include canonicalization, strict schema validation, policy-ba..."
chapter:
  id: C2
...
relatedControls:
  ...
  - id: C2.1.1
    title: "Normalize input before tokenization"
    href: /controls/c2-1-1-normalize-input-before-tokenization/
---

## What This Control Means

Encoding and representation smuggling in inputs is detected and mitigated. Approved mitigations include canonicalization, strict schema validation, policy-ba... This is a Level 1 requirement of OWASP AISVS 1.0 (Input Validation).
