...
standardVersion: "1.0"
controlId: C10.4.4
canonicalId: v1.0-C10.4.4
slug: c10-4-4-enforce-strict-mcp-schema-validation
title: "Enforce strict MCP schema validation"
summary: "All MCP servers enforce strict schema validation."
chapter:
  id: C10
...
All MCP servers enforce strict schema validation. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that all MCP servers enforce strict schema validation.
