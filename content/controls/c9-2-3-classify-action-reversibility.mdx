...
standardVersion: "1.0"
controlId: C9.2.3
canonicalId: v1.0-C9.2.3
slug: c9-2-3-classify-action-reversibility
title: "Classify action reversibility"
summary: "Each high-impact action has a trusted reversibility classification, such as read-only, reversible, externally reversible, or irreversible."
chapter:
  id: C9
...
Each high-impact action has a trusted reversibility classification, such as read-only, reversible, externally reversible, or irreversible. This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
