...
standardVersion: "1.0"
controlId: C4.2.2
canonicalId: v1.0-C4.2.2
slug: c4-2-2-use-tee-for-hardware-enforced-isolation
title: "Use TEE for hardware-enforced isolation"
summary: "Execution within a trusted execution environment (TEE) provides hardware-enforced isolation, memory encryption, and integrity protection."
chapter:
  id: C4
...
relatedControls:
  ...
  - id: C4.2.1
    ...
    href: /controls/c4-2-1-pin-sign-and-attest-accelerator-firmware/
---

## What This Control Means

Execution within a trusted execution environment (TEE) provides hardware-enforced isolation, memory encryption, and integrity protection. This is a Level 3 requirement of OWASP AISVS 1.0 (Infrastructure, Configuration & Deployment Security).
...
> Verify that execution within a trusted execution environment (TEE) provides hardware-enforced isolation, memory encryption, and integrity protection.
