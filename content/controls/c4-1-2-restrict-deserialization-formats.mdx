...
standardVersion: "1.0"
controlId: C4.1.2
canonicalId: v1.0-C4.1.2
slug: c4-1-2-restrict-deserialization-formats
title: "Restrict deserialization formats"
summary: "Model artifact loading enforces an explicit allow-list of serialization formats that do not permit arbitrary code execution during deserialization."
chapter:
  id: C4
...
relatedControls:
  - id: C4.1.3
    ...
    href: /controls/c4-1-3-attest-workloads-before-model-loading/
  - id: C4.1.1
    title: "Isolate AI models in sandboxes"
    href: /controls/c4-1-1-isolate-ai-models-in-sandboxes/
---

## What This Control Means

Model artifact loading enforces an explicit allow-list of serialization formats that do not permit arbitrary code execution during deserialization. This is a Level 1 requirement of OWASP AISVS 1.0 (Infrastructure, Configuration & Deployment Security).
...
> Verify that model artifact loading enforces an explicit allow-list of serialization formats that do not permit arbitrary code execution during deserialization.
