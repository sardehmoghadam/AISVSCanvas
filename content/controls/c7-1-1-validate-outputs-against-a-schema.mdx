...
standardVersion: "1.0"
controlId: C7.1.1
canonicalId: v1.0-C7.1.1
slug: c7-1-1-validate-outputs-against-a-schema
title: "Validate outputs against a schema"
summary: "The application validates all model outputs against a defined schema and rejects any output that does not match."
chapter:
  id: C7
...
The application validates all model outputs against a defined schema and rejects any output that does not match. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Behavior, Output Control & Safety Assurance).
...
> Verify that the application validates all model outputs against a defined schema and rejects any output that does not match.
