...
standardVersion: "1.0"
controlId: C10.4.5
canonicalId: v1.0-C10.4.5
slug: c10-4-5-enforce-mcp-payload-limits
title: "Enforce MCP payload limits"
summary: "All MCP transports enforce maximum payload size limits."
chapter:
  id: C10
...
All MCP transports enforce maximum payload size limits. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that all MCP transports enforce maximum payload size limits.
