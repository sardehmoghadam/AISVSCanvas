...
standardVersion: "1.0"
controlId: C12.1.1
canonicalId: v1.0-C12.1.1
slug: c12-1-1-log-ai-interactions-with-telemetry
title: "Log AI interactions with telemetry"
summary: "AI interactions are logged with session context and AI-specific telemetry."
chapter:
  id: C12
...
AI interactions are logged with session context and AI-specific telemetry. This is a Level 1 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that AI interactions are logged with session context and AI-specific telemetry.
