...
standardVersion: "1.0"
controlId: C8.2.4
canonicalId: v1.0-C8.2.4
slug: c8-2-4-detect-retrieval-manipulation-content
title: "Detect retrieval-manipulation content"
summary: "Content crafted to manipulate retrieval results is detected and rejected or quarantined before vectorization."
chapter:
  id: C8
...
relatedControls:
  - id: C8.2.5
    ...
    href: /controls/c8-2-5-check-memory-writes-for-contradictions/
  - id: C8.2.3
...
Content crafted to manipulate retrieval results is detected and rejected or quarantined before vectorization. This is a Level 3 requirement of OWASP AISVS 1.0 (Memory, Embeddings & Vector Database Security).
...
> Verify that content crafted to manipulate retrieval results is detected and rejected or quarantined before vectorization.
