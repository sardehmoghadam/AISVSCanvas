...
standardVersion: "1.0"
controlId: C8.3.1
canonicalId: v1.0-C8.3.1
slug: c8-3-1-exclude-expired-vectors-from-retrieval
title: "Exclude expired vectors from retrieval"
summary: "Expired vectors are excluded from retrieval results."
chapter:
  id: C8
...
Expired vectors are excluded from retrieval results. This is a Level 2 requirement of OWASP AISVS 1.0 (Memory, Embeddings & Vector Database Security).
...
> Verify that expired vectors are excluded from retrieval results.
