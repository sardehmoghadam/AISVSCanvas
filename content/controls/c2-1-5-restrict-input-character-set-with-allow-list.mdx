...
standardVersion: "1.0"
controlId: C2.1.5
canonicalId: v1.0-C2.1.5
slug: c2-1-5-restrict-input-character-set-with-allow-list
title: "Restrict input character set with allow-list"
summary: "The system implements a character set restriction for all inputs. The restriction must use an allow-list approach that permits only characters that are expli..."
chapter:
  id: C2
...
The system implements a character set restriction for all inputs. The restriction must use an allow-list approach that permits only characters that are expli... This is a Level 1 requirement of OWASP AISVS 1.0 (Input Validation).
