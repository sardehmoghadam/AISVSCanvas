...
standardVersion: "1.0"
controlId: C7.3.4
canonicalId: v1.0-C7.3.4
slug: c7-3-4-detect-hidden-output-content
title: "Detect hidden output content"
summary: "Model outputs are checked for hidden, encoded, or misleading content created through homoglyphs, formatting, metadata, or structured fields."
chapter:
  id: C7
...
relatedControls:
  - id: C7.4.1
    title: "Attribute RAG responses"
    href: /controls/c7-4-1-attribute-rag-responses/
  - id: C7.3.3
...
Model outputs are checked for hidden, encoded, or misleading content created through homoglyphs, formatting, metadata, or structured fields. This is a Level 3 requirement of OWASP AISVS 1.0 (Model Behavior, Output Control & Safety Assurance).
...
> Verify that model outputs are checked for hidden, encoded, or misleading content created through homoglyphs, formatting, metadata, or structured fields.
