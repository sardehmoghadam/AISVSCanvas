...
standardVersion: "1.0"
controlId: C3.4.2
canonicalId: v1.0-C3.4.2
slug: c3-4-2-isolate-training-from-production
title: "Isolate training from production"
summary: "Model training and fine-tuning environments are isolated from production environments."
chapter:
  id: C3
...
Model training and fine-tuning environments are isolated from production environments. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Lifecycle Management & Change Control).
...
> Verify that model training and fine-tuning environments are isolated from production environments.
