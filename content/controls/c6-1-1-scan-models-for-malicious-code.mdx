...
standardVersion: "1.0"
controlId: C6.1.1
canonicalId: v1.0-C6.1.1
slug: c6-1-1-scan-models-for-malicious-code
title: "Scan models for malicious code"
summary: "Models are scanned for malicious code before import."
chapter:
  id: C6
...
Models are scanned for malicious code before import. This is a Level 1 requirement of OWASP AISVS 1.0 (Supply Chain Security for Models).
