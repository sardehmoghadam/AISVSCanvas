...
standardVersion: "1.0"
controlId: C1.1.4
canonicalId: v1.0-C1.1.4
slug: c1-1-4-monitor-training-data-integrity
title: "Monitor training data integrity"
summary: "Integrity monitoring is applied to guard against unauthorized modifications or corruption of training data."
chapter:
  id: C1
...
relatedControls:
  - id: C1.1.5
    title: "Watermark datasets for provenance"
    href: /controls/c1-1-5-watermark-datasets-for-provenance/
  - id: C1.1.3
...
Integrity monitoring is applied to guard against unauthorized modifications or corruption of training data. This is a Level 2 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that integrity monitoring is applied to guard against unauthorized modifications or corruption of training data.
