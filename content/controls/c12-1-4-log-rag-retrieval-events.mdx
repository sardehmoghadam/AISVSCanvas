...
standardVersion: "1.0"
controlId: C12.1.4
canonicalId: v1.0-C12.1.4
slug: c12-1-4-log-rag-retrieval-events
title: "Log RAG retrieval events"
summary: "RAG pipeline retrieval events are logged, including the query, documents retrieved, and knowledge source."
chapter:
  id: C12
...
RAG pipeline retrieval events are logged, including the query, documents retrieved, and knowledge source. This is a Level 2 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that RAG pipeline retrieval events are logged, including the query, documents retrieved, and knowledge source.
