...
standardVersion: "1.0"
controlId: C2.1.8
canonicalId: v1.0-C2.1.8
slug: c2-1-8-detect-many-shot-jailbreaking
title: "Detect many-shot jailbreaking"
summary: "The system can detect many-shot jailbreaking patterns."
chapter:
  id: C2
...
The system can detect many-shot jailbreaking patterns. This is a Level 3 requirement of OWASP AISVS 1.0 (Input Validation).
