...
standardVersion: "1.0"
controlId: C5.2.3
canonicalId: v1.0-C5.2.3
slug: c5-2-3-retrieve-sensitive-data-via-pipelines
title: "Retrieve sensitive data via pipelines"
summary: "Sensitive data is retrieved via retrieval pipelines (e.g., RAG queries, embedding lookups) to prevent permanent storage in models."
chapter:
  id: C5
...
relatedControls:
  - id: C5.2.4
    title: "Filter unauthorized data from responses"
    href: /controls/c5-2-4-filter-unauthorized-data-from-responses/
  - id: C5.2.2
...
Sensitive data is retrieved via retrieval pipelines (e.g., RAG queries, embedding lookups) to prevent permanent storage in models. This is a Level 2 requirement of OWASP AISVS 1.0 (Access Control & Identity for AI Components & Users).
...
> Verify that sensitive data is retrieved via retrieval pipelines (e.g., RAG queries, embedding lookups) to prevent permanent storage in models.
