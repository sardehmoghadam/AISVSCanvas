...
standardVersion: "1.0"
controlId: C12.5.4
canonicalId: v1.0-C12.5.4
slug: c12-5-4-tag-ingested-documents-at-write-time
title: "Tag ingested documents at write time"
summary: "Every ingested document is tagged at write time with source, writer identity, and timestamp."
chapter:
  id: C12
...
relatedControls:
  - id: C12.5.3
    title: "Make model changes immutable"
    href: /controls/c12-5-3-make-model-changes-immutable/
---

## What This Control Means

Every ingested document is tagged at write time with source, writer identity, and timestamp. This is a Level 2 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that every ingested document is tagged at write time with source, writer identity, and timestamp.
