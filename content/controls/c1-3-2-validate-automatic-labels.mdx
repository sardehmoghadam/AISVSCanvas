...
standardVersion: "1.0"
controlId: C1.3.2
canonicalId: v1.0-C1.3.2
slug: c1-3-2-validate-automatic-labels
title: "Validate automatic labels"
summary: "Automatically generated labels are subject to confidence thresholds and consistency checks to detect misleading or low-confidence labels."
chapter:
  id: C1
...
relatedControls:
  ...
  - id: C1.3.1
    ...
    href: /controls/c1-3-1-detect-training-data-poisoning/
---

## What This Control Means

Automatically generated labels are subject to confidence thresholds and consistency checks to detect misleading or low-confidence labels. This is a Level 2 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that automatically generated labels are subject to confidence thresholds and consistency checks to detect misleading or low-confidence labels.
