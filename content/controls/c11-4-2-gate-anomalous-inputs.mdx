...
standardVersion: "1.0"
controlId: C11.4.2
canonicalId: v1.0-C11.4.2
slug: c11-4-2-gate-anomalous-inputs
title: "Gate anomalous inputs"
summary: "Inputs flagged as anomalous trigger gating actions."
chapter:
  id: C11
...
relatedControls:
  - id: C11.4.3
    ...
    href: /controls/c11-4-3-protect-feedback-pipeline-from-poisoning/
  - id: C11.4.1
...
Inputs flagged as anomalous trigger gating actions. This is a Level 2 requirement of OWASP AISVS 1.0 (Adversarial Robustness).
...
> Verify that inputs flagged as anomalous trigger gating actions.
