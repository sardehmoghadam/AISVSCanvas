...
standardVersion: "1.0"
controlId: C6.2.1
canonicalId: v1.0-C6.2.1
slug: c6-2-1-publish-machine-readable-ai-boms
title: "Publish machine-readable AI BOMs"
summary: "Every model artifact publishes a version-controlled, machine-readable AI BOM listing datasets, weights, licenses, and data-origin statements."
chapter:
  id: C6
...
relatedControls:
  ...
  - id: C6.1.4
    ...
    href: /controls/c6-1-4-run-behavioral-acceptance-tests/
---

## What This Control Means

Every model artifact publishes a version-controlled, machine-readable AI BOM listing datasets, weights, licenses, and data-origin statements. This is a Level 1 requirement of OWASP AISVS 1.0 (Supply Chain Security for Models).
