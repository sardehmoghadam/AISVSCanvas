...
standardVersion: "1.0"
controlId: C1.3.5
canonicalId: v1.0-C1.3.5
slug: c1-3-5-defend-against-clean-label-poisoning
title: "Defend against clean-label poisoning"
summary: "Defenses against clean-label poisoning attacks are implemented."
chapter:
  id: C1
...
Defenses against clean-label poisoning attacks are implemented. This is a Level 3 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that defenses against clean-label poisoning attacks are implemented.
