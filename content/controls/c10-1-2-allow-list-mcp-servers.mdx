...
standardVersion: "1.0"
controlId: C10.1.2
canonicalId: v1.0-C10.1.2
slug: c10-1-2-allow-list-mcp-servers
title: "Allow-list MCP servers"
summary: "Only allow-listed MCP servers are permitted."
chapter:
  id: C10
...
relatedControls:
  ...
  - id: C10.1.1
    ...
    href: /controls/c10-1-1-verify-mcp-component-provenance/
---

## What This Control Means

Only allow-listed MCP servers are permitted. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that only allow-listed MCP servers are permitted.
