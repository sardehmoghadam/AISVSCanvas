...
standardVersion: "1.0"
controlId: C6.1.3
canonicalId: v1.0-C6.1.3
slug: c6-1-3-verify-third-party-artifact-integrity
title: "Verify third-party artifact integrity"
summary: "Every third-party model artifact can be integrity-verified."
chapter:
  id: C6
...
relatedControls:
  ...
  - id: C6.1.2
    ...
    href: /controls/c6-1-2-download-from-approved-sources-only/
---

## What This Control Means

Every third-party model artifact can be integrity-verified. This is a Level 2 requirement of OWASP AISVS 1.0 (Supply Chain Security for Models).
