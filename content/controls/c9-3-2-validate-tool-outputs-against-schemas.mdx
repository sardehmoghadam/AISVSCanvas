...
standardVersion: "1.0"
controlId: C9.3.2
canonicalId: v1.0-C9.3.2
slug: c9-3-2-validate-tool-outputs-against-schemas
title: "Validate tool outputs against schemas"
summary: "Tool outputs are validated against schemas."
chapter:
  id: C9
...
Tool outputs are validated against schemas. This is a Level 1 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
