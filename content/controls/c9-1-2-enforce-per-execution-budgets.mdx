...
standardVersion: "1.0"
controlId: C9.1.2
canonicalId: v1.0-C9.1.2
slug: c9-1-2-enforce-per-execution-budgets
title: "Enforce per-execution budgets"
summary: "Per-execution budgets (e.g., max recursion depth, token use, and monetary spend) are configured and enforced by the runtime."
chapter:
  id: C9
...
relatedControls:
  ...
  - id: C9.1.1
    ...
    href: /controls/c9-1-1-enforce-per-tool-quotas-and-timeouts/
---

## What This Control Means

Per-execution budgets (e.g., max recursion depth, token use, and monetary spend) are configured and enforced by the runtime. This is a Level 1 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
...
> Verify that per-execution budgets (e.g., max recursion depth, token use, and monetary spend) are configured and enforced by the runtime.
