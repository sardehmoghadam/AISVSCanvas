...
standardVersion: "1.0"
controlId: C10.4.1
canonicalId: v1.0-C10.4.1
slug: c10-4-1-validate-mcp-responses-against-schemas
title: "Validate MCP responses against schemas"
summary: "MCP tools/list and tools/call responses are validated against their declared schemas before being injected into the model context."
chapter:
  id: C10
...
relatedControls:
  - id: C10.4.2
    title: "Screen MCP responses for injection"
    href: /controls/c10-4-2-screen-mcp-responses-for-injection/
  - id: C10.3.5
    title: "Sender-constrain MCP tokens"
    href: /controls/c10-3-5-sender-constrain-mcp-tokens/
---

## What This Control Means

MCP tools/list and tools/call responses are validated against their declared schemas before being injected into the model context. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP tools/list and tools/call responses are validated against their declared schemas before being injected into the model context.
