...
standardVersion: "1.0"
controlId: C11.2.1
canonicalId: v1.0-C11.2.1
slug: c11-2-1-suppress-inferred-sensitive-attributes
title: "Suppress inferred sensitive attributes"
summary: "Model-inferred sensitive attributes are not directly returned in outputs."
chapter:
  id: C11
...
relatedControls:
  - id: C11.2.2
    ...
    href: /controls/c11-2-2-size-rate-limits-to-extraction-threat/
  - id: C11.1.5
...
Model-inferred sensitive attributes are not directly returned in outputs. This is a Level 1 requirement of OWASP AISVS 1.0 (Adversarial Robustness).
...
> Verify that model-inferred sensitive attributes are not directly returned in outputs.
