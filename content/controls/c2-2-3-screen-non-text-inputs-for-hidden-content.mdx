...
standardVersion: "1.0"
controlId: C2.2.3
canonicalId: v1.0-C2.2.3
slug: c2-2-3-screen-non-text-inputs-for-hidden-content
title: "Screen non-text inputs for hidden content"
summary: "Non-text inputs (image/video/audio) are checked for adversarial perturbations, steganographic payloads, hidden or embedded content, or known attack patterns."
chapter:
  id: C2
...
relatedControls:
  - id: C2.2.4
    title: "Detect coordinated multi-input attacks"
    href: /controls/c2-2-4-detect-coordinated-multi-input-attacks/
  - id: C2.2.2
...
Non-text inputs (image/video/audio) are checked for adversarial perturbations, steganographic payloads, hidden or embedded content, or known attack patterns. This is a Level 2 requirement of OWASP AISVS 1.0 (Input Validation).
