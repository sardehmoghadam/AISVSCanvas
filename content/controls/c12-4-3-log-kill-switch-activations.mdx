...
standardVersion: "1.0"
controlId: C12.4.3
canonicalId: v1.0-C12.4.3
slug: c12-4-3-log-kill-switch-activations
title: "Log kill-switch activations"
summary: "Kill-switch activations and override commands are logged."
chapter:
  id: C12
...
relatedControls:
  - id: C12.5.1
    ...
    href: /controls/c12-5-1-record-dataset-lineage/
  - id: C12.4.2
...
Kill-switch activations and override commands are logged. This is a Level 2 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that kill-switch activations and override commands are logged.
