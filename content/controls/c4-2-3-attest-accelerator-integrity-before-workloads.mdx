...
standardVersion: "1.0"
controlId: C4.2.3
canonicalId: v1.0-C4.2.3
slug: c4-2-3-attest-accelerator-integrity-before-workloads
title: "Attest accelerator integrity before workloads"
summary: "AI accelerator (GPU) integrity is validated using hardware-based attestation mechanisms before each workload executes."
chapter:
  id: C4
...
AI accelerator (GPU) integrity is validated using hardware-based attestation mechanisms before each workload executes. This is a Level 3 requirement of OWASP AISVS 1.0 (Infrastructure, Configuration & Deployment Security).
...
> Verify that AI accelerator (GPU) integrity is validated using hardware-based attestation mechanisms before each workload executes.
