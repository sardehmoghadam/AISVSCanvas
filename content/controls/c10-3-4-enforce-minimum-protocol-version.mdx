...
standardVersion: "1.0"
controlId: C10.3.4
canonicalId: v1.0-C10.3.4
slug: c10-3-4-enforce-minimum-protocol-version
title: "Enforce minimum protocol version"
summary: "MCP clients enforce a minimum acceptable protocol version and reject initialize responses that propose a version below that minimum."
chapter:
  id: C10
...
MCP clients enforce a minimum acceptable protocol version and reject initialize responses that propose a version below that minimum. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP clients enforce a minimum acceptable protocol version and reject initialize responses that propose a version below that minimum.
