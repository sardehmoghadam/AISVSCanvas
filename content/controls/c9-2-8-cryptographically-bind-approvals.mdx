...
standardVersion: "1.0"
controlId: C9.2.8
canonicalId: v1.0-C9.2.8
slug: c9-2-8-cryptographically-bind-approvals
title: "Cryptographically bind approvals"
summary: "Approvals are cryptographically bound to action parameters, requester identity, execution context, and a unique single-use nonce."
chapter:
  id: C9
...
Approvals are cryptographically bound to action parameters, requester identity, execution context, and a unique single-use nonce. This is a Level 3 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
