...
standardVersion: "1.0"
controlId: C2.1.1
canonicalId: v1.0-C2.1.1
slug: c2-1-1-normalize-input-before-tokenization
title: "Normalize input before tokenization"
summary: "Input normalization is applied before tokenization or embedding."
chapter:
  id: C2
...
Input normalization is applied before tokenization or embedding. This is a Level 1 requirement of OWASP AISVS 1.0 (Input Validation).
