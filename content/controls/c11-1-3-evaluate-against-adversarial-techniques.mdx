...
standardVersion: "1.0"
controlId: C11.1.3
canonicalId: v1.0-C11.1.3
slug: c11-1-3-evaluate-against-adversarial-techniques
title: "Evaluate against adversarial techniques"
summary: "Models are evaluated against known adversarial attack techniques relevant to their modality."
chapter:
  id: C11
...
Models are evaluated against known adversarial attack techniques relevant to their modality. This is a Level 1 requirement of OWASP AISVS 1.0 (Adversarial Robustness).
...
> Verify that models are evaluated against known adversarial attack techniques relevant to their modality.
