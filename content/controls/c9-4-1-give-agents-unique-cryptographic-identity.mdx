...
standardVersion: "1.0"
controlId: C9.4.1
canonicalId: v1.0-C9.4.1
slug: c9-4-1-give-agents-unique-cryptographic-identity
title: "Give agents unique cryptographic identity"
summary: "Each agent instance has a unique cryptographic identity and authenticates as a first-class principal to downstream systems."
chapter:
  id: C9
...
Each agent instance has a unique cryptographic identity and authenticates as a first-class principal to downstream systems. This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
