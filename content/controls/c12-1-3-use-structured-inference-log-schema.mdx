...
standardVersion: "1.0"
controlId: C12.1.3
canonicalId: v1.0-C12.1.3
slug: c12-1-3-use-structured-inference-log-schema
title: "Use structured inference log schema"
summary: "Log entries for AI inference events follow a structured, interoperable schema that includes at least the model identifier, token usage (input and output), pr..."
chapter:
  id: C12
...
relatedControls:
  ...
  - id: C12.1.2
    title: "Log safety filtering decisions"
    href: /controls/c12-1-2-log-safety-filtering-decisions/
---

## What This Control Means

Log entries for AI inference events follow a structured, interoperable schema that includes at least the model identifier, token usage (input and output), pr... This is a Level 2 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that log entries for AI inference events follow a structured, interoperable schema that includes at least the model identifier, token usage (input and output), provider name, and operation type.
