...
standardVersion: "1.0"
controlId: C10.2.2
canonicalId: v1.0-C10.2.2
slug: c10-2-2-validate-token-claims-per-oauth-2-1
title: "Validate token claims per OAuth 2.1"
summary: "MCP servers validate the presented access token's issuer, audience, expiration, and scope claims in accordance with OAuth 2.1."
chapter:
  id: C10
...
relatedControls:
  ...
  - id: C10.2.1
    title: "Validate MCP access tokens"
    href: /controls/c10-2-1-validate-mcp-access-tokens/
---

## What This Control Means

MCP servers validate the presented access token's issuer, audience, expiration, and scope claims in accordance with OAuth 2.1. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP servers validate the presented access token's issuer, audience, expiration, and scope claims in accordance with OAuth 2.1.
