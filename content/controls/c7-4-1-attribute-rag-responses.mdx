...
standardVersion: "1.0"
controlId: C7.4.1
canonicalId: v1.0-C7.4.1
slug: c7-4-1-attribute-rag-responses
title: "Attribute RAG responses"
summary: "Responses generated using retrieval-augmented generation (RAG) include attribution to the source documents."
chapter:
  id: C7
...
Responses generated using retrieval-augmented generation (RAG) include attribution to the source documents. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Behavior, Output Control & Safety Assurance).
...
> Verify that responses generated using retrieval-augmented generation (RAG) include attribution to the source documents.
