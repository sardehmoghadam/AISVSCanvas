...
standardVersion: "1.0"
controlId: C2.1.6
canonicalId: v1.0-C2.1.6
slug: c2-1-6-enforce-instruction-hierarchy
title: "Enforce instruction hierarchy"
summary: "The system enforces an instruction hierarchy in which system and developer messages override user instructions and other untrusted inputs, even after user in..."
chapter:
  id: C2
...
relatedControls:
  - id: C2.1.7
    ...
    href: /controls/c2-1-7-encode-reserved-special-tokens/
  - id: C2.1.5
...
The system enforces an instruction hierarchy in which system and developer messages override user instructions and other untrusted inputs, even after user in... This is a Level 2 requirement of OWASP AISVS 1.0 (Input Validation).
