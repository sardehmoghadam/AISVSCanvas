...
standardVersion: "1.0"
controlId: C10.4.8
canonicalId: v1.0-C10.4.8
slug: c10-4-8-re-approve-changed-tool-definitions
title: "Re-approve changed tool definitions"
summary: "MCP clients maintain a snapshot of tool definitions and that any change to a tool definition triggers re-approval before the modified tool can be invoked."
chapter:
  id: C10
...
relatedControls:
  - id: C10.4.7
    ...
    href: /controls/c10-4-7-require-consent-for-local-mcp-installs/
---

## What This Control Means

MCP clients maintain a snapshot of tool definitions and that any change to a tool definition triggers re-approval before the modified tool can be invoked. This is a Level 3 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP clients maintain a snapshot of tool definitions and that any change to a tool definition triggers re-approval before the modified tool can be invoked.
