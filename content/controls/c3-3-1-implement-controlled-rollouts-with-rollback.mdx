...
standardVersion: "1.0"
controlId: C3.3.1
canonicalId: v1.0-C3.3.1
slug: c3-3-1-implement-controlled-rollouts-with-rollback
title: "Implement controlled rollouts with rollback"
summary: "Production deployments implement rollout mechanisms with automated rollback triggers."
chapter:
  id: C3
...
Production deployments implement rollout mechanisms with automated rollback triggers. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Lifecycle Management & Change Control).
...
> Verify that production deployments implement rollout mechanisms with automated rollback triggers.
