...
standardVersion: "1.0"
controlId: C9.2.5
canonicalId: v1.0-C9.2.5
slug: c9-2-5-bound-self-modification-capabilities
title: "Bound self-modification capabilities"
summary: "Any self-modification capability (e.g., prompt rewriting, tool-list changes, parameter updates) is restricted by enforceable boundaries."
chapter:
  id: C9
...
relatedControls:
  ...
  - id: C9.2.4
    ...
    href: /controls/c9-2-4-enforce-reversibility-classifications/
---

## What This Control Means

Any self-modification capability (e.g., prompt rewriting, tool-list changes, parameter updates) is restricted by enforceable boundaries. This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
