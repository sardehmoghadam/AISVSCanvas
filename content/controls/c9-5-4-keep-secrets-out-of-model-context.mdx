...
standardVersion: "1.0"
controlId: C9.5.4
canonicalId: v1.0-C9.5.4
slug: c9-5-4-keep-secrets-out-of-model-context
title: "Keep secrets out of model context"
summary: "Secrets and credentials required by an agent at runtime are not exposed within the model's observable context, including the context window, system prompts,..."
chapter:
  id: C9
...
Secrets and credentials required by an agent at runtime are not exposed within the model's observable context, including the context window, system prompts,... This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
