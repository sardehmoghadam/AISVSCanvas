...
standardVersion: "1.0"
controlId: C9.2.9
canonicalId: v1.0-C9.2.9
slug: c9-2-9-isolate-approval-key-material
title: "Isolate approval key material"
summary: "Cryptographic key material or credentials used to issue approvals are isolated from the agent runtime."
chapter:
  id: C9
...
Cryptographic key material or credentials used to issue approvals are isolated from the agent runtime. This is a Level 3 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
