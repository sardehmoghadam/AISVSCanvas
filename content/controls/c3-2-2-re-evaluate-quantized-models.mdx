...
standardVersion: "1.0"
controlId: C3.2.2
canonicalId: v1.0-C3.2.2
slug: c3-2-2-re-evaluate-quantized-models
title: "Re-evaluate quantized models"
summary: "Models subjected to post-training quantization are re-evaluated against the same safety and alignment test suite on the compressed artifact before deployment."
chapter:
  id: C3
...
relatedControls:
  - id: C3.2.3
    ...
    href: /controls/c3-2-3-re-evaluate-on-model-changes/
  - id: C3.2.1
...
Models subjected to post-training quantization are re-evaluated against the same safety and alignment test suite on the compressed artifact before deployment. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Lifecycle Management & Change Control).
...
> Verify that models subjected to post-training quantization are re-evaluated against the same safety and alignment test suite on the compressed artifact before deployment.
