...
standardVersion: "1.0"
controlId: C9.5.2
canonicalId: v1.0-C9.5.2
slug: c9-5-2-propagate-scope-limited-user-tokens
title: "Propagate scope-limited user tokens"
summary: "When an agent acts on a user's behalf, the runtime propagates an integrity-protected, scope-limited token that carries the user's authorization context and i..."
chapter:
  id: C9
...
relatedControls:
  - id: C9.5.3
    title: "Enforce access control outside the model"
    href: /controls/c9-5-3-enforce-access-control-outside-the-model/
  - id: C9.5.1
    title: "Authorize actions against fine-grained policy"
    href: /controls/c9-5-1-authorize-actions-against-fine-grained-policy/
---

## What This Control Means

When an agent acts on a user's behalf, the runtime propagates an integrity-protected, scope-limited token that carries the user's authorization context and i... This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
