...
standardVersion: "1.0"
controlId: C8.2.5
canonicalId: v1.0-C8.2.5
slug: c8-2-5-check-memory-writes-for-contradictions
title: "Check memory writes for contradictions"
summary: "New content written to memory is checked for contradictions with what is already stored and that conflicts trigger alerts."
chapter:
  id: C8
...
relatedControls:
  - id: C8.3.1
    title: "Exclude expired vectors from retrieval"
    href: /controls/c8-3-1-exclude-expired-vectors-from-retrieval/
  - id: C8.2.4
    title: "Detect retrieval-manipulation content"
    href: /controls/c8-2-4-detect-retrieval-manipulation-content/
---

## What This Control Means

New content written to memory is checked for contradictions with what is already stored and that conflicts trigger alerts. This is a Level 3 requirement of OWASP AISVS 1.0 (Memory, Embeddings & Vector Database Security).
...
> Verify that new content written to memory is checked for contradictions with what is already stored and that conflicts trigger alerts.
