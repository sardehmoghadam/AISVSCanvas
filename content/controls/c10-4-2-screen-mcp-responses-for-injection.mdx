...
standardVersion: "1.0"
controlId: C10.4.2
canonicalId: v1.0-C10.4.2
slug: c10-4-2-screen-mcp-responses-for-injection
title: "Screen MCP responses for injection"
summary: "MCP tools/list and tools/call responses are screened for indirect prompt injection before being injected into the model context."
chapter:
  id: C10
...
relatedControls:
  - id: C10.4.3
    title: "Reject unrecognized parameters"
    href: /controls/c10-4-3-reject-unrecognized-parameters/
  - id: C10.4.1
...
MCP tools/list and tools/call responses are screened for indirect prompt injection before being injected into the model context. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP tools/list and tools/call responses are screened for indirect prompt injection before being injected into the model context.
