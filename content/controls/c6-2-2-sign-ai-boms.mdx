...
standardVersion: "1.0"
controlId: C6.2.2
canonicalId: v1.0-C6.2.2
slug: c6-2-2-sign-ai-boms
title: "Sign AI BOMs"
summary: "AI BOMs are cryptographically signed before deployment."
chapter:
  id: C6
...
relatedControls:
  - id: C6.2.3
    ...
    href: /controls/c6-2-3-fail-build-on-incomplete-ai-boms/
  - id: C6.2.1
...
AI BOMs are cryptographically signed before deployment. This is a Level 2 requirement of OWASP AISVS 1.0 (Supply Chain Security for Models).
