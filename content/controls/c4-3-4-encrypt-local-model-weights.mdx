...
standardVersion: "1.0"
controlId: C4.3.4
canonicalId: v1.0-C4.3.4
slug: c4-3-4-encrypt-local-model-weights
title: "Encrypt local model weights"
summary: "Model weights and sensitive parameters stored locally are encrypted using hardware-backed key stores or secure enclaves."
chapter:
  id: C4
...
relatedControls:
  - id: C4.3.5
    ...
    href: /controls/c4-3-5-encrypt-packaged-models-at-rest/
  - id: C4.3.3
...
Model weights and sensitive parameters stored locally are encrypted using hardware-backed key stores or secure enclaves. This is a Level 3 requirement of OWASP AISVS 1.0 (Infrastructure, Configuration & Deployment Security).
...
> Verify that model weights and sensitive parameters stored locally are encrypted using hardware-backed key stores or secure enclaves.
