...
standardVersion: "1.0"
controlId: C12.5.3
canonicalId: v1.0-C12.5.3
slug: c12-5-3-make-model-changes-immutable
title: "Make model changes immutable"
summary: "All model changes generate immutable audit records."
chapter:
  id: C12
...
relatedControls:
  - id: C12.5.4
    ...
    href: /controls/c12-5-4-tag-ingested-documents-at-write-time/
  - id: C12.5.2
...
All model changes generate immutable audit records. This is a Level 2 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that all model changes generate immutable audit records.
