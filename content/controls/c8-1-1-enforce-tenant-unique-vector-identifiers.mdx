...
standardVersion: "1.0"
controlId: C8.1.1
canonicalId: v1.0-C8.1.1
slug: c8-1-1-enforce-tenant-unique-vector-identifiers
title: "Enforce tenant-unique vector identifiers"
summary: "Vector identifiers and namespaces enforce uniqueness per tenant and prevent cross-tenant collisions."
chapter:
  id: C8
...
relatedControls:
  - id: C8.1.2
    ...
    href: /controls/c8-1-2-make-document-metadata-tags-immutable/
---

## What This Control Means

Vector identifiers and namespaces enforce uniqueness per tenant and prevent cross-tenant collisions. This is a Level 1 requirement of OWASP AISVS 1.0 (Memory, Embeddings & Vector Database Security).
...
> Verify that vector identifiers and namespaces enforce uniqueness per tenant and prevent cross-tenant collisions.
