...
standardVersion: "1.0"
controlId: C9.5.5
canonicalId: v1.0-C9.5.5
slug: c9-5-5-restrict-inter-agent-delegation
title: "Restrict inter-agent delegation"
summary: "Inter-agent task delegation is restricted by an explicit authorization policy."
chapter:
  id: C9
...
Inter-agent task delegation is restricted by an explicit authorization policy. This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
