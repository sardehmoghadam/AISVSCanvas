...
standardVersion: "1.0"
controlId: C9.3.8
canonicalId: v1.0-C9.3.8
slug: c9-3-8-automate-tool-containment-on-policy-violations
title: "Automate tool containment on policy violations"
summary: "Policy violations trigger automated tool containment."
chapter:
  id: C9
...
Policy violations trigger automated tool containment. This is a Level 3 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
