...
standardVersion: "1.0"
controlId: C8.2.3
canonicalId: v1.0-C8.2.3
slug: c8-2-3-validate-agent-outputs-before-memory-writes
title: "Validate agent outputs before memory writes"
summary: "Agent outputs and tool outputs are not automatically written to trusted agent memory without explicit source validation."
chapter:
  id: C8
...
Agent outputs and tool outputs are not automatically written to trusted agent memory without explicit source validation. This is a Level 2 requirement of OWASP AISVS 1.0 (Memory, Embeddings & Vector Database Security).
