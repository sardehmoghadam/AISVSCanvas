...
standardVersion: "1.0"
controlId: C12.3.1
canonicalId: v1.0-C12.3.1
slug: c12-3-1-detect-data-drift
title: "Detect data drift"
summary: "Data drift detection monitors input distribution changes that may impact model performance, using statistically validated methods matched to the input data t..."
chapter:
  id: C12
...
relatedControls:
  - id: C12.3.2
    ...
    href: /controls/c12-3-2-detect-hallucination/
  - id: C12.2.6
    title: "Monitor for covert-channel indicators"
    href: /controls/c12-2-6-monitor-for-covert-channel-indicators/
---

## What This Control Means

Data drift detection monitors input distribution changes that may impact model performance, using statistically validated methods matched to the input data t... This is a Level 1 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that data drift detection monitors input distribution changes that may impact model performance, using statistically validated methods matched to the input data type (e.g., KS test or PSI for tabular numeric features, embedding-distance metrics for text or image).
