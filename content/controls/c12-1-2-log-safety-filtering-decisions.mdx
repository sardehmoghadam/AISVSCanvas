...
standardVersion: "1.0"
controlId: C12.1.2
canonicalId: v1.0-C12.1.2
slug: c12-1-2-log-safety-filtering-decisions
title: "Log safety filtering decisions"
summary: "Safety filtering and policy decisions are logged with sufficient detail to support audit, debugging, and forensic analysis of content moderation systems."
chapter:
  id: C12
...
relatedControls:
  - id: C12.1.3
    ...
    href: /controls/c12-1-3-use-structured-inference-log-schema/
  - id: C12.1.1
    title: "Log AI interactions with telemetry"
    href: /controls/c12-1-1-log-ai-interactions-with-telemetry/
---

## What This Control Means

Safety filtering and policy decisions are logged with sufficient detail to support audit, debugging, and forensic analysis of content moderation systems. This is a Level 2 requirement of OWASP AISVS 1.0 (Monitoring, Logging & Anomaly Detection).
...
> Verify that safety filtering and policy decisions are logged with sufficient detail to support audit, debugging, and forensic analysis of content moderation systems.
