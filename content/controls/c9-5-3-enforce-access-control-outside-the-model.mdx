...
standardVersion: "1.0"
controlId: C9.5.3
canonicalId: v1.0-C9.5.3
slug: c9-5-3-enforce-access-control-outside-the-model
title: "Enforce access control outside the model"
summary: "All access control decisions are enforced by application logic or a policy engine, never by the AI model itself."
chapter:
  id: C9
...
relatedControls:
  - id: C9.5.4
    ...
    href: /controls/c9-5-4-keep-secrets-out-of-model-context/
  - id: C9.5.2
...
All access control decisions are enforced by application logic or a policy engine, never by the AI model itself. This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
