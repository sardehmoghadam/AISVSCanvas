...
standardVersion: "1.0"
controlId: C5.3.1
canonicalId: v1.0-C5.3.1
slug: c5-3-1-prevent-cross-tenant-model-interference
title: "Prevent cross-tenant model interference"
summary: "Shared model serving infrastructure prevents one tenant's fine-tuning, inference, or embedding operations from influencing or observing another tenant's oper..."
chapter:
  id: C5
...
relatedControls:
  - id: C5.3.2
    title: "Prevent cross-tenant compute observation"
    href: /controls/c5-3-2-prevent-cross-tenant-compute-observation/
  - id: C5.2.7
...
Shared model serving infrastructure prevents one tenant's fine-tuning, inference, or embedding operations from influencing or observing another tenant's oper... This is a Level 2 requirement of OWASP AISVS 1.0 (Access Control & Identity for AI Components & Users).
...
> Verify that shared model serving infrastructure prevents one tenant's fine-tuning, inference, or embedding operations from influencing or observing another tenant's operations.
