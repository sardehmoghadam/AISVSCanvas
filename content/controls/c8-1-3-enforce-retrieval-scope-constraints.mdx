...
standardVersion: "1.0"
controlId: C8.1.3
canonicalId: v1.0-C8.1.3
slug: c8-1-3-enforce-retrieval-scope-constraints
title: "Enforce retrieval scope constraints"
summary: "Retrieval operations enforce scope constraints."
chapter:
  id: C8
...
Retrieval operations enforce scope constraints. This is a Level 2 requirement of OWASP AISVS 1.0 (Memory, Embeddings & Vector Database Security).
...
> Verify that retrieval operations enforce scope constraints.
