...
standardVersion: "1.0"
controlId: C4.3.5
canonicalId: v1.0-C4.3.5
slug: c4-3-5-encrypt-packaged-models-at-rest
title: "Encrypt packaged models at rest"
summary: "Models packaged within mobile, IoT, or embedded applications are encrypted at rest, and decrypted only inside a trusted runtime or secure enclave, preventing..."
chapter:
  id: C4
...
Models packaged within mobile, IoT, or embedded applications are encrypted at rest, and decrypted only inside a trusted runtime or secure enclave, preventing... This is a Level 3 requirement of OWASP AISVS 1.0 (Infrastructure, Configuration & Deployment Security).
...
> Verify that models packaged within mobile, IoT, or embedded applications are encrypted at rest, and decrypted only inside a trusted runtime or secure enclave, preventing direct extraction from the app package or filesystem.
