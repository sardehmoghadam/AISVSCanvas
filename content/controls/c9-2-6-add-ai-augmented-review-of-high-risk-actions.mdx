...
standardVersion: "1.0"
controlId: C9.2.6
canonicalId: v1.0-C9.2.6
slug: c9-2-6-add-ai-augmented-review-of-high-risk-actions
title: "Add AI-augmented review of high-risk actions"
summary: "Agentic systems include an AI-augmented review of planned high-risk actions before execution that adds to, and does not replace, the deterministic policy gate."
chapter:
  id: C9
...
relatedControls:
  - id: C9.2.7
    title: "Protect review from manipulation"
    href: /controls/c9-2-7-protect-review-from-manipulation/
  - id: C9.2.5
...
Agentic systems include an AI-augmented review of planned high-risk actions before execution that adds to, and does not replace, the deterministic policy gate. This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
...
> Verify that agentic systems include an AI-augmented review of planned high-risk actions before execution that adds to, and does not replace, the deterministic policy gate.
