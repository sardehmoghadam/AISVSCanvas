...
standardVersion: "1.0"
controlId: C10.2.1
canonicalId: v1.0-C10.2.1
slug: c10-2-1-validate-mcp-access-tokens
title: "Validate MCP access tokens"
summary: "MCP servers validate access tokens for each request and do not rely on transport security alone."
chapter:
  id: C10
...
relatedControls:
  ...
  - id: C10.1.3
    ...
    href: /controls/c10-1-3-sandbox-local-mcp-servers/
---

## What This Control Means

MCP servers validate access tokens for each request and do not rely on transport security alone. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP servers validate access tokens for each request and do not rely on transport security alone.
