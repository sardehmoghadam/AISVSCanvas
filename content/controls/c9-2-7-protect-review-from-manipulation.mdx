...
standardVersion: "1.0"
controlId: C9.2.7
canonicalId: v1.0-C9.2.7
slug: c9-2-7-protect-review-from-manipulation
title: "Protect review from manipulation"
summary: "The AI-augmented review mechanism is protected against manipulation by adversarial inputs, and cannot be overridden or bypassed through prompt injection."
chapter:
  id: C9
...
relatedControls:
  - id: C9.2.8
    title: "Cryptographically bind approvals"
    href: /controls/c9-2-8-cryptographically-bind-approvals/
  - id: C9.2.6
    title: "Add AI-augmented review of high-risk actions"
    href: /controls/c9-2-6-add-ai-augmented-review-of-high-risk-actions/
---

## What This Control Means

The AI-augmented review mechanism is protected against manipulation by adversarial inputs, and cannot be overridden or bypassed through prompt injection. This is a Level 2 requirement of OWASP AISVS 1.0 (Orchestration & Agentic Security).
