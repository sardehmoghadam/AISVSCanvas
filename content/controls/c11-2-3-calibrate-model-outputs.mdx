...
standardVersion: "1.0"
controlId: C11.2.3
canonicalId: v1.0-C11.2.3
slug: c11-2-3-calibrate-model-outputs
title: "Calibrate model outputs"
summary: "Model outputs are calibrated to reduce overconfident predictions."
chapter:
  id: C11
...
Model outputs are calibrated to reduce overconfident predictions. This is a Level 2 requirement of OWASP AISVS 1.0 (Adversarial Robustness).
...
> Verify that model outputs are calibrated to reduce overconfident predictions.
