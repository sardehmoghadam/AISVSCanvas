...
standardVersion: "1.0"
controlId: C1.1.3
canonicalId: v1.0-C1.1.3
slug: c1-1-3-protect-training-data-integrity-in-storage-and-transfer
title: "Protect training data integrity in storage and transfer"
summary: "Data integrity is provided when training data is stored and transferred."
chapter:
  id: C1
...
relatedControls:
  - id: C1.1.4
    ...
    href: /controls/c1-1-4-monitor-training-data-integrity/
  - id: C1.1.2
...
Data integrity is provided when training data is stored and transferred. This is a Level 2 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that data integrity is provided when training data is stored and transferred.
