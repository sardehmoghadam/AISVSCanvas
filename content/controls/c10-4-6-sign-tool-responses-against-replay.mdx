...
standardVersion: "1.0"
controlId: C10.4.6
canonicalId: v1.0-C10.4.6
slug: c10-4-6-sign-tool-responses-against-replay
title: "Sign tool responses against replay"
summary: "MCP servers sign tool responses with a unique nonce and timestamp so MCP clients can detect replay attempts."
chapter:
  id: C10
...
relatedControls:
  ...
  - id: C10.4.5
    title: "Enforce MCP payload limits"
    href: /controls/c10-4-5-enforce-mcp-payload-limits/
---

## What This Control Means

MCP servers sign tool responses with a unique nonce and timestamp so MCP clients can detect replay attempts. This is a Level 2 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP servers sign tool responses with a unique nonce and timestamp so MCP clients can detect replay attempts.
