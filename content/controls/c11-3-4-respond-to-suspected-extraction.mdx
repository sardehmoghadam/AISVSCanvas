...
standardVersion: "1.0"
controlId: C11.3.4
canonicalId: v1.0-C11.3.4
slug: c11-3-4-respond-to-suspected-extraction
title: "Respond to suspected extraction"
summary: "Detection of suspected extraction triggers response measures."
chapter:
  id: C11
...
relatedControls:
  - id: C11.4.1
    ...
    href: /controls/c11-4-1-anomaly-detect-inputs-before-inference/
  - id: C11.3.3
...
Detection of suspected extraction triggers response measures. This is a Level 3 requirement of OWASP AISVS 1.0 (Adversarial Robustness).
...
> Verify that detection of suspected extraction triggers response measures.
