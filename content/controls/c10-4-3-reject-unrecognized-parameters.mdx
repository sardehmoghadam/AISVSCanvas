...
standardVersion: "1.0"
controlId: C10.4.3
canonicalId: v1.0-C10.4.3
slug: c10-4-3-reject-unrecognized-parameters
title: "Reject unrecognized parameters"
summary: "MCP servers reject unrecognized or oversized parameters in function calls."
chapter:
  id: C10
...
relatedControls:
  - id: C10.4.4
    title: "Enforce strict MCP schema validation"
    href: /controls/c10-4-4-enforce-strict-mcp-schema-validation/
  - id: C10.4.2
...
MCP servers reject unrecognized or oversized parameters in function calls. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP servers reject unrecognized or oversized parameters in function calls.
