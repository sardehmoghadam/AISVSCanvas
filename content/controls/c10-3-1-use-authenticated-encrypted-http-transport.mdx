...
standardVersion: "1.0"
controlId: C10.3.1
canonicalId: v1.0-C10.3.1
slug: c10-3-1-use-authenticated-encrypted-http-transport
title: "Use authenticated encrypted HTTP transport"
summary: "Authenticated, encrypted streamable HTTP is used for MCP transport for remote services."
chapter:
  id: C10
...
relatedControls:
  ...
  - id: C10.2.7
    title: "Do not pass through access tokens"
    href: /controls/c10-2-7-do-not-pass-through-access-tokens/
---

## What This Control Means

Authenticated, encrypted streamable HTTP is used for MCP transport for remote services. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that authenticated, encrypted streamable HTTP is used for MCP transport for remote services.
