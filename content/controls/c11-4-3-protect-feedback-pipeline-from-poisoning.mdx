...
standardVersion: "1.0"
controlId: C11.4.3
canonicalId: v1.0-C11.4.3
slug: c11-4-3-protect-feedback-pipeline-from-poisoning
title: "Protect feedback pipeline from poisoning"
summary: "The safety violation feedback pipeline includes poisoning detection and human review gates to prevent adversarial manipulation of the improvement mechanism."
chapter:
  id: C11
...
The safety violation feedback pipeline includes poisoning detection and human review gates to prevent adversarial manipulation of the improvement mechanism. This is a Level 3 requirement of OWASP AISVS 1.0 (Adversarial Robustness).
...
> Verify that the safety violation feedback pipeline includes poisoning detection and human review gates to prevent adversarial manipulation of the improvement mechanism.
