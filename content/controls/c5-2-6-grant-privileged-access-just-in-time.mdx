...
standardVersion: "1.0"
controlId: C5.2.6
canonicalId: v1.0-C5.2.6
slug: c5-2-6-grant-privileged-access-just-in-time
title: "Grant privileged access just in time"
summary: "Privileged access to model weights, training pipelines, and production AI configuration is granted just in time, with a defined maximum session duration and..."
chapter:
  id: C5
...
relatedControls:
  - id: C5.2.7
    ...
    href: /controls/c5-2-7-propagate-data-classification-labels/
  - id: C5.2.5
    title: "Isolate the policy decision point"
    href: /controls/c5-2-5-isolate-the-policy-decision-point/
---

## What This Control Means

Privileged access to model weights, training pipelines, and production AI configuration is granted just in time, with a defined maximum session duration and... This is a Level 3 requirement of OWASP AISVS 1.0 (Access Control & Identity for AI Components & Users).
...
> Verify that privileged access to model weights, training pipelines, and production AI configuration is granted just in time, with a defined maximum session duration and automatic expiry. Zero Standing Privilege (ZSP) to these resources is encouraged.
