...
standardVersion: "1.0"
controlId: C10.1.1
canonicalId: v1.0-C10.1.1
slug: c10-1-1-verify-mcp-component-provenance
title: "Verify MCP component provenance"
summary: "MCP components are obtained only from trusted sources and cryptographically verified."
chapter:
  id: C10
...
MCP components are obtained only from trusted sources and cryptographically verified. This is a Level 1 requirement of OWASP AISVS 1.0 (Model Context Protocol (MCP) Security).
...
> Verify that MCP components are obtained only from trusted sources and cryptographically verified.
