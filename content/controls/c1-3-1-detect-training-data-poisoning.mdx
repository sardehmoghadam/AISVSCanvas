...
standardVersion: "1.0"
controlId: C1.3.1
canonicalId: v1.0-C1.3.1
slug: c1-3-1-detect-training-data-poisoning
title: "Detect training data poisoning"
summary: "Training and fine-tuning pipelines implement poisoning detection techniques to identify potential data poisoning or unintentional corruption in training data."
chapter:
  id: C1
...
relatedControls:
  - id: C1.3.2
    title: "Validate automatic labels"
    href: /controls/c1-3-2-validate-automatic-labels/
  - id: C1.2.3
    title: "Protect sensitive label content"
    href: /controls/c1-2-3-protect-sensitive-label-content/
---

## What This Control Means

Training and fine-tuning pipelines implement poisoning detection techniques to identify potential data poisoning or unintentional corruption in training data. This is a Level 2 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that training and fine-tuning pipelines implement poisoning detection techniques to identify potential data poisoning or unintentional corruption in training data.
