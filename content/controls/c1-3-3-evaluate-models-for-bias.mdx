...
standardVersion: "1.0"
controlId: C1.3.3
canonicalId: v1.0-C1.3.3
slug: c1-3-3-evaluate-models-for-bias
title: "Evaluate models for bias"
summary: "Models used in security-relevant decisions are evaluated for bias patterns."
chapter:
  id: C1
...
relatedControls:
  - id: C1.3.4
    ...
    href: /controls/c1-3-4-remove-disallowed-content-before-training/
  - id: C1.3.2
...
Models used in security-relevant decisions are evaluated for bias patterns. This is a Level 2 requirement of OWASP AISVS 1.0 (Training Data Integrity & Traceability).
...
> Verify that models used in security-relevant decisions are evaluated for bias patterns.
