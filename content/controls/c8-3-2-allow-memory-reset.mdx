...
standardVersion: "1.0"
controlId: C8.3.2
canonicalId: v1.0-C8.3.2
slug: c8-3-2-allow-memory-reset
title: "Allow memory reset"
summary: "Memory can be reset."
chapter:
  id: C8
...
relatedControls:
  - id: C8.3.3
    ...
    href: /controls/c8-3-3-retain-quarantined-content-out-of-retrieval/
  - id: C8.3.1
...
Memory can be reset. This is a Level 2 requirement of OWASP AISVS 1.0 (Memory, Embeddings & Vector Database Security).
...
> Verify that memory can be reset.
